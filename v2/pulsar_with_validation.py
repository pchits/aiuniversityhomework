...
rf_prediction = forest.predict(X_val)
...
recall_estimate = cross_val_score(forest, X_val, y_val, cv=10, scoring='recall_weighted')
print("Recall: " + str(round(100*recall_estimate.mean(), 2)) + "%")

y_pred = cross_val_predict(forest, X_val, y_val, cv=10)
